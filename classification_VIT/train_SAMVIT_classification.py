...
import os
from model.unet_vit_classification import vit_encoder_b, load_weight_for_vit_encoder
# from model.flava_model import Flava_encoder_classification
# from model.clip_model import Clip_encoder_classification
# from model.align_model import Align_encoder_classification

new_settings = {
    "vit": {
        "lvm-med-vit": './lvm_med_weights/lvmmed_vit.pth',
    }
}
...
def TrainingTesting(cfg, numtry, pretrained_weight_name, data_path, num_classes, data_tranform, device, solver, name_weights, 
                    frozen_encoder, architecture_type, number_epoch=50, learning_rate=0.001, batch_size=32, 
                    test_mode='best_valid', valid_rate=0.2):
    # Load the datasets
